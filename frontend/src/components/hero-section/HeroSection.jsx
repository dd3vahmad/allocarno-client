                ...
                <div className="hero-section">
                        ...
                        <div className="navbar-links">
                            ...
                            <div className="dropdown nav-link">
                                <Link to="/" className="flex items-center gap-2 dropdown-toggle">
                                    Other <span><FaChevronDown className='FaChevronDown' /></span>
                                </Link>
                    ...
                    <div className="hero">
                        <div className="notification relative top-[-.5rem]">
                            ...
                            <span className="notification-text">10,000+ Smart Schedules Generated</span>
                        </div>

                        <div className="relative hero-text-wrapper top-[-1rem]">
                            <div className="relative hero-heading">
                                <div>
                                    <h1>Enhance Your University <br /> System with <span className='hero-heading-highlight'>Allocarno</span></h1>
                                </div>
                            ...
                            <div className="hero-paragraph">
                                <p> No more manual planning. Just verified, stress-free timetables powered by AI, secured by Cardano, and built for real academic peace of mind.</p>
                            </div>
                        </div>
                        <div className="hero-dashboard-preview-wrapper mt-[2rem]">
                            <div className="hero-dashboard-preview w-[100%] mx-auto">
                                <img src={dashboardPreview} alt="" className='w-[100%] object-cover' />
                            </div>
                        </div>
                    </div>
                </div>
