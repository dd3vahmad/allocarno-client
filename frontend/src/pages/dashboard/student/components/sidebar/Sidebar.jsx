            ...
            <div className="sidebar-section">
                ...
                <ul className="sidebar-menu">
                    ...
                    <Link to="/dashboard/student/registration">
                        <li className={`flex items-center gap-4 ${currentPage === "registration" ? "active" : ""}`}>
                            <span className="menu-icon">
                                <IoPersonAddOutline />
                            </span>
                            <p> Registration</p>
                    ...
                    <Link to="/dashboard/student/timetable">
                        <li className={`flex items-center gap-4 ${currentPage === "timetable" ? "active" : ""}`}>
                            <span className="menu-icon">
                    ...
                    <Link to="/dashboard/student/complain">
                        <li className={`flex items-center gap-4 ${currentPage === "complain" ? "active" : ""}`}>
                            <span className="menu-icon">
                                <BiMessageError />
                            </span>
                            <p>Make Complait</p>
