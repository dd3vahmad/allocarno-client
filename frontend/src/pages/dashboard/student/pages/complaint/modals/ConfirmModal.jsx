            ...
            <div className={`modal-overlay ${isClosing ? "closing" : ""}`}>
                <div className={`modal-container ${isClosing ? "closing" : ""}`} onClick={(e) => e.stopPropagation()}>
                    <div className="flex items-center justify-between modal-container-header">
                        <h2 className="modal-title">Are you sure you want to submit this complaint?</h2>
                    ...
                    <div className="modal-body px-[54px] py-[44px]">
                        <p className="modal-text">
                            Please confirm that all the information you've entered is accurate. <br /> Once submitted, your complaint will be
                            sent to the admin team for review.
                        </p>
